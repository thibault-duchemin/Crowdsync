 ...
 *
 */
public class JWNLConfig {


    /**
     * The location of the configuration file. 
     */
    public static String CONFIG_PATH = "jwnl_properties/";
     ...
     */
    public static String testingType = JWNLConfig.MAP;
    ...
    public static InputStream getInputStream() {
        System.out.println("PATH " + (CONFIG_PATH + MAP_CONFIG_NAME));
        try {
            if (testingType.equals(JWNLConfig.FILE)) {
                return new FileInputStream((CONFIG_PATH + FILE_CONFIG_NAME));
            } else if (testingType.equals(JWNLConfig.DB)) {
                return new FileInputStream((CONFIG_PATH + DATABASE_CONFIG_NAME));
            } else if (testingType.equals(JWNLConfig.MAP)) {
